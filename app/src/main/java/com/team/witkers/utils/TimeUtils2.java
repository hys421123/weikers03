...
public class TimeUtils2 {
	...
	public final static String FORMAT_TIME_SECOND="MMddHHmmss";
	...
	private static final int DAY2=2*24*60*60;//2天
	...
	public static String getDescriptionTimeFromTimestamp(long timestamp) {
		...
		String thisYear=longToString(currentTime,FORMAT_YEAR);
		String pubYear=longToString(timestamp,FORMAT_YEAR);
		if(!thisYear.equals(pubYear)){//若不是今年
			timeStr = longToString(timestamp,FORMAT_DATE_TIME);
			return timeStr;
		}

		if (timeGap > DAY2) {
			timeStr = longToString(timestamp,FORMAT_MONTH_DAY_TIME);
		} else if (timeGap > DAY) {// 1天以上
			timeStr=getMessageTime(timestamp);
